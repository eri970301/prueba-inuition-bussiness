...
function App() {
  return (
    <div className="App">
          ...
          <div id="screen" className="screen mostrar">
            <div id="alerta" className="text-center position-absolute start-50 translate-middle-x card_button opacity-0">
              <div className="card-body rounded-lg" style={{ backgroundColor: "#b71ddd" }}>
                <p className="card-text fw-bold text-white">Haz click en el animal que produjo el sonido</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <img src={burro} className="img_animals burro"></img>
          </div>
          <div>
            <img src={caballo} className="img_animals caballo"></img>
          </div>
          <div>
            <img src={perro} className="img_animals perro"></img>
          </div>
          <div>
            <img src={vaca} className="img_animals vaca"></img>
          </div>
          <div>
            <img src={conejo} className="img_animals conejo"></img>
          </div>
          <div>
            <img src={marrano} className="img_animals marrano"></img>
          </div>
          <div>
            <img src={gallina} className="img_animals gallina"></img>
          </div>
          <div>
            <img src={oveja} className="img_animals oveja" ></img>
          </div>
    </div>
  );
}
